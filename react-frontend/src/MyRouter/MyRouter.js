...
import SingleLecturerPage from "../components/LecturerPage/SingleLecturerPage";
import LecturerProjectLayoutPage from "../components/LecturerPage/LecturerProjectLayoutPage";
import SingleSubjectPage from "../components/SubjectPage/SingleSubjectPage";
import SubjectProjectLayoutPage from "../components/SubjectPage/SubjectProjectLayoutPage";
import SingleStudentPage from "../components/StudentPage/SingleStudentPage";
import StudentProjectLayoutPage from "../components/StudentPage/StudentProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/subject/:singleSubjectId" exact element={<SingleSubjectPage />} />
<Route path="/subject" exact element={<SubjectProjectLayoutPage />} />
