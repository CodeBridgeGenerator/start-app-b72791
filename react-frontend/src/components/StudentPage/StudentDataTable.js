...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.studentID?.subjectID}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.studentName}</p>
    ...
    const paginatorRight = DownloadCSV({ data : items, fileName : "student"});
...
<Column field="studentID" header="StudentID" body={dropdownTemplate0} filter={selectedFilterFields.includes("studentID")} hidden={selectedHideFields?.includes("studentID")}  style={{ minWidth: "8rem" }} />
<Column field="studentName" header="StudentName" body={pTemplate1} filter={selectedFilterFields.includes("studentName")} hidden={selectedHideFields?.includes("studentName")}  sortable style={{ minWidth: "8rem" }} />
