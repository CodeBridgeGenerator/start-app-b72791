...
const LecturerPage = (props) => {
    ...
    const service = _.find(config.services, { serviceName : "lecturer"});
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">Lecturer </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                    <Button label="add" loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="lecturer-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="lecturer-datatable">
...
/>
            ...
            <LecturerCreateDialogComponent entity={newRecord} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
