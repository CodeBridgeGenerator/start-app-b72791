...
const LecturerCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            lecturerID: _entity?.lecturerID,
lecturerName: _entity?.lecturerName,
lecturerSubject: _entity?.lecturerSubject,
        };
    ...
    return (
        <Dialog header="Edit Lecturer" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
