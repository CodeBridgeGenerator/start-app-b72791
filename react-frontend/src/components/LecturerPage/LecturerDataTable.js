...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.lecturerID}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.lecturerName}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.lecturerSubject}</p>
    ...
    const paginatorRight = DownloadCSV({ data : items, fileName : "lecturer"});
...
<Column field="lecturerID" header="Lecturer ID" body={pTemplate0} filter={selectedFilterFields.includes("lecturerID")} hidden={selectedHideFields?.includes("lecturerID")}  sortable style={{ minWidth: "8rem" }} />
<Column field="lecturerName" header="Lecturer Name" body={pTemplate1} filter={selectedFilterFields.includes("lecturerName")} hidden={selectedHideFields?.includes("lecturerName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="lecturerSubject" header="Lecturer Subject" body={pTemplate2} filter={selectedFilterFields.includes("lecturerSubject")} hidden={selectedHideFields?.includes("lecturerSubject")}  sortable style={{ minWidth: "8rem" }} />
